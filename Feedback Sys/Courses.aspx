<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Courses.aspx.cs" Inherits="Feedback_Sys.Courses" %>
    ...
    <form id="form1" runat="server">
     ...
     <div class="container-fluid container-xl position-relative d-flex align-items-center">
        ...
        <div class="table-responsive">
            <asp:Table ID="CourseTable" runat="server" CssClass="table table-striped table-hover" />
        </div>
        <div class="color">
            <div class="container">
